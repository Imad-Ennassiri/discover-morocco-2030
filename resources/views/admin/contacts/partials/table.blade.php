        ...
        <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors group">
            ...
            <td class="px-8 py-5 text-right">
                <div class="flex items-center justify-end space-x-3">
                    <button type="button" class="view-btn p-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl transition-colors" title="View" data-contact="{{ e($contact->toJson()) }}">
